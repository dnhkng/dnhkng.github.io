...
A blog post can't be peer-reviewed, but it *can* be cited. Somewhat to my surprise, this one has been, mostly by people working on looped and recurrent Transformers who arrived at the same neighbourhood from a different direction. In chronological order:
